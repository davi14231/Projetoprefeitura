      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between py-3">
          ...
          <nav className="flex items-center gap-4 min-w-fit justify-end">
            ...
            >
              <div className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors text-sm border-b-2 border-blue-400 pb-1 whitespace-nowrap cursor-pointer">
