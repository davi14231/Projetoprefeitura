...
export default function HomeUnificada({ imagensCarrossel, itens, tipo }) {
  // tipo: 'publica' (header inicial, bloco ONG) ou 'ong' (header ONG, bloco ONG2)
  ...
  return (
    <div>
      {tipo === 'ong' ? <Headerinicio /> : <HeaderTelainicial />}
