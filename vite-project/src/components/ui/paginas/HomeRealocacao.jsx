...
export function HomeRealocacao() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="max-w-6xl mx-auto py-10 px-4 text-center">
          ...
          <p className="text-gray-700 mb-8 text-lg">
            Tem um item sobrando? Anuncie aqui e ajude outra organização parceira que está precisando.
          </p>
          <button
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
              {destaques.map((item) => (
                <div key={item.id} className="min-w-[140px] flex flex-col items-center">
                  ...
                  />
                  <span className="mt-2 text-sm font-medium text-gray-700 text-center">{item.titulo}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="flex justify-between items-center mt-2">
            <div className="w-1/2 text-center text-sm font-medium bg-neutral-100 py-2 rounded-l-lg">
              Solicitações postadas
            </div>
            <div className="w-1/2 text-center text-sm font-medium bg-neutral-100 py-2 rounded-r-lg">
          ...
          <Card className="w-full bg-white border">
            <CardContent className="py-6 px-8">
              ...
              <p className="text-gray-700 mb-4 text-base">
                Se sua ONG possui itens que podem beneficiar outras instituições, utilize nossa plataforma para ampliar o impacto da sua solidariedade.
              </p>
              <button
                className="bg-[#172233] text-white px-5 py-2 rounded-lg font-medium hover:bg-[#22304d] transition flex items-center gap-2"
                style={{ backgroundColor: footerColor }}
              >
                + Publicar Meus Excedentes
              </button>
            </CardContent>
          </Card>
        </section>
          ...
          <Card className="w-full bg-white border">
            <CardContent className="py-6 px-8">
              <div className="flex flex-col gap-6">
                {pedidos.map((pedido) => (
                <div key={pedido.id} className="flex items-start gap-4 border-b pb-6 last:border-b-0 last:pb-0">
                    <img
                    src={pedido.imageUrl}
                    alt={pedido.titulo}
                    ...
                    <div className="flex items-center gap-2">
                        <span className="font-semibold text-lg text-gray-800">{pedido.titulo}</span>
                    ...
                    <div className="text-sm text-gray-500 mt-1 flex items-center gap-4">
                        ...
                        <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" className="inline-block"><circle cx="8" cy="8" r="7" /><path d="M8 4v4l2 2" /></svg>
              ...
              <div className="flex justify-center items-center gap-2 mt-8">
                <button className="w-8 h-8 rounded bg-[#172233] text-white font-bold" style={{ backgroundColor: footerColor }}>1</button>
                <button className="w-8 h-8 rounded text-neutral-900 font-bold hover:bg-neutral-200">2</button>
                <button className="w-8 h-8 rounded text-neutral-900 font-bold hover:bg-neutral-200">3</button>
                <span className="px-2 text-neutral-500 font-bold">...</span>
                <button className="w-8 h-8 rounded text-neutral-900 font-bold hover:bg-neutral-200">67</button>
                <button className="w-8 h-8 rounded text-neutral-900 font-bold hover:bg-neutral-200">68</button>
              </div>
            </CardContent>
          </Card>
        </section>
