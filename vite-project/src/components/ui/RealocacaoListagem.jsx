      ...
      const data = [
        {
          ...
          validade: "15/07/2024",
          imagem: "/imagens/CestasBasicas.jpg",
        },
        {
          id: 2,
          categoria: "Roupas",
          ...
          validade: "",
          imagem: "/imagens/RoupasInfantis.jpg",
        },
        {
          id: 3,
        ...
        },
        {
          ...
          validade: "",
          imagem: "/imagens/BrinquedosEdu.jpg",
        },
        {
          id: 6,
    ...
    <div className="my-new-screen" style={{ background: "#b9d2f7", minHeight: "100vh" }}>
      ...
      <main>
        <div className="rounded-xl bg-[#b9d2f7] py-6 px-2">
          ...
          {/* Filtros centralizados e largura igual aos cards */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", gap: 16, width: "100%" }}>
              <div style={{ flex: 1, display: "flex", alignItems: "center", position: "relative" }}>
                {/* Lupa removida, só Vector.jpg no título */}
                <input
                  type="text"
